...
public class Client {
	...
	public static FileSystemItem createCompositeFromFile(File file) {
		if(!file.isDirectory()) return new br.com.jamesson.estructural_patterns.composite.folders.model.File(file.getName());
	...
	public static void main(String[] args) {
		FileSystemItem file1 = new br.com.jamesson.estructural_patterns.composite.folders.model.File("File1.txt");
		FileSystemItem file2 = new br.com.jamesson.estructural_patterns.composite.folders.model.File("File2.txt");
		FileSystemItem file3 = new br.com.jamesson.estructural_patterns.composite.folders.model.File("File3.txt");
		FileSystemItem file4 = new br.com.jamesson.estructural_patterns.composite.folders.model.File("File4.txt");
