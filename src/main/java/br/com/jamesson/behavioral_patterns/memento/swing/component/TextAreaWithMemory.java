package br.com.jamesson.behavioral_patterns.memento.swing.component;

import javax.swing.JTextArea;

import br.com.jamesson.behavioral_patterns.memento.swing.memory.Memento;
...
public class TextAreaWithMemory extends JTextArea {
	...
	public static class TextAreaMemento implements Memento {
		...
		private TextAreaMemento(String text) {
			this.text = text;
		}
